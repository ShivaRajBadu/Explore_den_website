...
const page = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 bg-gray-50">
      ...
      <p>Welcome to exploreden.com!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of ExploreDen's Website, located at https://exploreden.com.au/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use exploreden.com if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing exploreden.com, you agreed to
        use cookies in agreement with the ExploreDen's Privacy Policy.{" "}
      </p>
      ...
      <p>
        ...
        exploreden.com for your own personal use subjected to restrictions set
      ...
      <p>
        ...
        ExploreDen does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of ExploreDen,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, ExploreDen shall not be
      ...
      <p>
        ExploreDen reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant ExploreDen a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of ExploreDen; and (d) the link is
      ...
      <p>
        ...
        e-mail to ExploreDen. Please include your name, your organization name,
      ...
      <p>
        No use of ExploreDen's logo or other artwork will be allowed for linking
