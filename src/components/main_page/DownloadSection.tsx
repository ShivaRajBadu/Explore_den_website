  ...
  return (
    <div className="bg-brand  text-background relative mt-10 ">
      ...
      <div className="max-w-[1440px] w-full lg:w-[90%] mx-auto">
        <div className="flex gap-4 lg:gap-28 justify-between items-center h-[164px] sm:h-[260px] md:h-[380px] lg:h-[530px] relative">
          <Image
          ...
          {/* </div> */}
          <div className="w-[60%] ">
            <h1 className="font-semibold   text-[15px] sm:text-[28px]  md:text-[30px] lg:text-[38px] xl:text-[48px] text-pretty text-background">
            ...
            <div className="flex   items-center gap-2  md:gap-4 pt-3 md:pt-12">
              <Image
                ...
                width={0}
                height={0}
                className="cursor-pointer w-[60px] sm:w-[90px] md:w-[130px] lg:w-[180px] h-auto"
              />
              <Image
