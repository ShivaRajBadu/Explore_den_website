    ...
    <div>
      ...
      <div className="flex gap-10 py-10">
        <Link
          href="/blogs/1"
          prefetch={false}
          className={` card_shadow pb-2 w-[50%] block  hover:rounded-[16px] cursor-pointer`}
        >
          <Image
            src="/images/blog.jpg"
            alt="blog"
            ...
            height={0}
            sizes="(100vw, 100vh)"
            className="w-full object-cover h-[390px] rounded-2xl"
          />
        ...
        <div className="w-[50%] flex flex-col gap-8">
          <Link
            href="/blogs/1"
            prefetch={false}
            className={` card_shadow  duration-300 flex gap-6  hover:rounded-[16px] cursor-pointer`}
          >
            <div>
              <Image
                src="/images/blog.jpg"
          ...
          <Link
            href="/blogs/1"
            prefetch={false}
            className={` card_shadow  flex gap-6  hover:rounded-[16px] cursor-pointer`}
          >
            <div>
              <Image
                src="/images/blog.jpg"
